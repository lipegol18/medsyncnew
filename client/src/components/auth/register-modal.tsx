...
export function RegisterModal({
  ...
  // TEMPORÁRIO: Iniciar direto na seleção de planos para melhorar UX/design
  const [currentStep, setCurrentStep] = useState<'form' | 'pricing' | 'confirmation' | 'trial-welcome' | 'error'>('pricing');
    ...
    return (
      <div>
        ...
        <div className="text-center mb-6 sm:mb-8 px-2">
          ...
          <p className="text-gray-600 leading-relaxed font-medium text-sm sm:text-base max-w-md mx-auto">
            Transforme sua prática médica com nossa plataforma completa de autorização e gestão
          </p>
